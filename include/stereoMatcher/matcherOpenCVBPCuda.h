#ifndef MATCHEROPENCVBPCUDA_H
#define MATCHEROPENCVBPCUDA_H

#include "stereoMatcher/abstractStereoMatcher.h"
#include "opencv2/cudastereo.hpp"

class MatcherOpenCVBPCuda : public AbstractStereoMatcher
{
public:
    explicit MatcherOpenCVBPCuda(std::string &param_file, cv::Size _image_size)
